...
namespace PorteFolio.LIB
{
    ...
    public class FicheCompetence
    {
        ...
        public FicheCompetence(Boolean IsNew)
        {
        ...
        {
            FicheCompetence context = new FicheCompetence(false);
        ...
        public void Initialize()
        {
            ...
            description = @"Projet Sucradom réalisé en fin de 2ème anée de BTS pour l'épreuve E4"
                        + @"- Réalisation d'un site de commande de friandises" 
                        + @"- Réalisation d'un outils de gestion des stocks";
            this.ListMissions.Add(new Mission(1, "Projet E4", description));

            description = @"Projets EntretienSPPP et QualiteSPPP"
                        + @"- Réalisation d'un outils de gestion des entretiens individuels"
                        + @"- Réalisation d'un outils de suivi de qualité";
            this.ListMissions.Add(new Mission(2, "Stage 1ere année", description));

            description = @"Projets EntretienSPPP et Presentation SPPP"
                        + @"- Refonte de EntretienSPPP passage sous WPF"
                        + @"- Réalisation d'un outils de gestion documentaire multilangue" 
                        + @"- Réalisation d'un site intranet de consultation de documents";
            this.ListMissions.Add(new Mission(3, "Stage 2eme année", description));

            FicheCompetence.Save(this, "FicheCompetences");
        }
    }
